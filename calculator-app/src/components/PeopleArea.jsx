...
export default function ({ onPersonChange }) {
  const [person, setPerson] = useState();
  function handleChange(e) {
    const persons = e.target.valueAsNumber;
    setPerson(persons);
    onPersonChange(persons);
  }
    ...
    <>
      <div id="people-area">
        ...
        <div className="input-container">
          <input
            type="number"
            id="money-input inputs"
            className="amount-input"
            value={person}
            onChange={handleChange}
            style={{
              border: person === 0 ? "2px solid red" : undefined,
            }}
          />
